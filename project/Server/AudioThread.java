    ...
    public void run(){
        ...
        try {
            ...
            while (isRunning){
                ...
                if (client2BytesRead >= 0){ //send data from client 2 to client 1
                    out1.write(client2Data);
                }
                if (client1BytesRead >= 0){ //send data from client 1 to client 2
                    out2.write(client1Data);
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
